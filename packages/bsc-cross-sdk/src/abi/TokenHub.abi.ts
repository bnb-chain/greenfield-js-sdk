export const TokenHubAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: 'uint256',
        name: 'largeTransferLimit',
        type: 'uint256',
      },
    ],
    name: 'LargeTransferLimitSet',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  {
    inputs: [],
    name: 'MAX_TRANSFER_BNB_FROM_MULTI_MESSAGE',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  {
    inputs: [],
    name: 'MIN_SEQUENCE_FROM_MULTI_MESSAGE',
    outputs: [
      {
        internalType: 'uint64',
        name: '',

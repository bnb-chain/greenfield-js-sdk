...
import { IRawTxInfo, ISignature712, TransferTx } from '@bnb-chain/greenfield-chain-sdk';
import { ethers } from 'ethers';
import { useState } from 'react';
import { useAccount, useNetwork } from 'wagmi';
import { client } from '@/client';

export const TransferArv = () => {
    ...
    <div>
      ...
      <button
        onClick={async () => {
          ...
          const { accountNumber, sequence } = await client.account.getAccount(address);
